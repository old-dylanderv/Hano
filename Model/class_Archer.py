...
class Archer(Mob):
    def __init__(self, x, y, windowWidth, strength):
        ...
        atkList = Atk("fleche", 2, 32, 16, {"idleLeft":[pygame.image.load("Images/Archer/Fleche.png").convert_alpha()],"idleRight":[pygame.transform.flip(pygame.image.load("Images/Archer/Fleche.png").convert_alpha(),True,False)]}, 1, 3, -1, 0.05, 15, -1, 3000),
