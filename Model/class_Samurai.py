...
class Samurai(Mob):
    def __init__(self, x, y, windowWidth, strength):
        ...
        atkList = Atk("sabre", 3, 96, 96, {"idleLeft":[pygame.image.load("Images/Blanchon/particlehit.png").convert_alpha()],"idleRight":[pygame.transform.flip(pygame.image.load("Images/Blanchon/particlehit.png").convert_alpha(),True,False)]}, 10, 6, -3, 0, 4, 0, 400),
